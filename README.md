...
- Visit ['How to contribute'](#how-to-contribute) if you find a mistake or anything missed in this repo

## Recent Updates

- [2018-08-13, AGC, a25-constructor-naming-error](ERC20_token_issue_list.md#a25-constructor-naming-error)
- [2018-07-31, AMORCOIN, a24-getToken-anyone](ERC20_token_issue_list.md#a24-getToken-anyone)
...
```
- [`token_dict.json`](token_dict.json) lists addresses and basic info of ERC20 contracts collected by [CoinMarketCap](https://coinmarketcap.com/tokens/)
- [`token_detail_dict.json`](token_detail_dict.json) lists addresses and detailed info of ERC20 contracts collected by [CoinMarketCap](https://coinmarketcap.com/tokens/)
...
For now we only maintain detailed information of token contracts (totalSupply, decimals, exchanges) that have market caps on CoinMarketCap. If you find any other incompatible/buggy/vulnerable ERC20 token contracts, please update [`token_dict.json`](token_dict.json) and run script [`gen_token_detail_dict.py`](gen_token_detail_dict.py).
...
- \[7\] [Tsinghua-360 Research Center of Enterprise Security: ERC20智能合约整数溢出系列漏洞披露](https://www.secrss.com/articles/3289), Jun 12, 2018
- \[8\] [ChainDD: 【得得预警】ERC20智能合约又现大量整数溢出漏洞](http://www.chaindd.com/3083754.html), Jun 12, 2018
